...
package com.dgreentec.domain.xsd.retDistDFeInt_v101;
    ...
    implements Serializable
{
        ...
        implements Serializable
    {
        ...
        private final static long serialVersionUID = -1L;
        @XmlElement(name = "docZip", required = true)
        protected List<RetDistDFeInt.LoteDistDFeInt.DocZip> docZips;

        /**
         * Gets the value of the docZips property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the docZips property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getDocZips().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<RetDistDFeInt.LoteDistDFeInt.DocZip> getDocZips() {
            if (docZips == null) {
                docZips = new ArrayList<RetDistDFeInt.LoteDistDFeInt.DocZip>();
            }
            return this.docZips;
        }
