    ...
    implements Serializable
{
    ...
    @XmlElement(name = "procEventoNFe")
    protected List<TProcEvento> procEventoNves;
    ...
    /**
     * Gets the value of the procEventoNves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the procEventoNves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProcEventoNves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TProcEvento> getProcEventoNves() {
        if (procEventoNves == null) {
            procEventoNves = new ArrayList<TProcEvento>();
        }
        return this.procEventoNves;
    }
