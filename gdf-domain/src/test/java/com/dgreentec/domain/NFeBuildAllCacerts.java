...
public class NFeBuildAllCacerts {
	...
	private static final String CACERTS_PATH = System.getProperty("user.dir")
			+ "/src/test/resources/certificados/keystore";
	...
	public void gerar() {
		try {
			...
			in.close();
			/**
			 * // HOMOLOGACAO // AM - https://homnfe.sefaz.am.gov.br
			 * get("homnfe.sefaz.am.gov.br", 443, ks); // BA -
			 * https://hnfe.sefaz.ba.gov.br get("hnfe.sefaz.ba.gov.br", 443,
			 * ks); // CE - https://nfeh.sefaz.ce.gov.br
			 * get("nfeh.sefaz.ce.gov.br", 443, ks); // ES -
			 * https://app.sefaz.es.gov.br get("app.sefaz.es.gov.br", 443, ks);
			 * // GO - https://homolog.sefaz.go.gov.br
			 * get("homolog.sefaz.go.gov.br", 443, ks); // MG -
			 * https://hnfe.fazenda.mg.gov.br get("hnfe.fazenda.mg.gov.br", 443,
			 * ks); // MS - https://homologacao.nfe.ms.gov.br
			 * get("homologacao.nfe.ms.gov.br", 443, ks); // MT -
			 * https://homologacao.sefaz.mt.gov.br
			 * get("homologacao.sefaz.mt.gov.br", 443, ks); // PE -
			 * https://nfehomolog.sefaz.pe.gov.br
			 * get("nfehomolog.sefaz.pe.gov.br", 443, ks); // PR -
			 * https://homologacao.nfe2.fazenda.pr.gov.br
			 * get("/homologacao.nfe.fazenda.pr.gov.br", 443, ks); // RS -
			 * https://homologacao.nfe.sefaz.rs.gov.br
			 * get("homologacao.nfe.sefaz.rs.gov.br", 443, ks); // RS2 -
			 * https://sef.sefaz.rs.gov.br get("sef.sefaz.rs.gov.br", 443, ks);
			 * // SP - https://homologacao.nfe.fazenda.sp.gov.br
			 * get("homologacao.nfe.fazenda.sp.gov.br", 443, ks); // SVAN -
			 * https://hom.sefazvirtual.fazenda.gov.br
			 * get("hom.sefazvirtual.fazenda.gov.br", 443, ks); // SVRS -
			 * https://homologacao.nfe.sefazvirtual.rs.gov.br
			 * get("homologacao.nfe.sefazvirtual.rs.gov.br", 443, ks); // SVRS
			 * NfeConsultaCadastro - https://webservice.set.rn.gov.br
			 * get("webservice.set.rn.gov.br", 443, ks); // SCAN -
			 * https://hom.nfe.fazenda.gov.br get("hom.nfe.fazenda.gov.br", 443,
			 * ks); // SVC-AN - https://hom.svc.fazenda.gov.br
			 * get("hom.svc.fazenda.gov.br", 443, ks); // AN -
			 * https://hom.nfe.fazenda.gov.br get("hom.nfe.fazenda.gov.br", 443,
			 * ks);
			 **/
