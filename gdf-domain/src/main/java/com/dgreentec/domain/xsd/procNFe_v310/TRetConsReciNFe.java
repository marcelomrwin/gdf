    ...
    implements Serializable
{
    ...
    protected List<TProtNFe> protNves;
    ...
    /**
     * Gets the value of the protNves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the protNves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProtNves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TProtNFe> getProtNves() {
        if (protNves == null) {
            protNves = new ArrayList<TProtNFe>();
        }
        return this.protNves;
    }
