    ...
    implements Serializable
{
    ...
    protected List<TRetEvento> retEventos;
    ...
    /**
     * Gets the value of the retEventos property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the retEventos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRetEventos().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TRetEvento> getRetEventos() {
        if (retEventos == null) {
            retEventos = new ArrayList<TRetEvento>();
        }
        return this.retEventos;
    }
